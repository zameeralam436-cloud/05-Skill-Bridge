...
import { Compass, Menu, X, Sparkles, User, Briefcase, ShieldCheck, ChevronRight, LogOut } from 'lucide-react';
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-b border-slate-200 bg-white px-4 pt-3 pb-6 space-y-3 animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col gap-2.5">
            {currentUser ? (
              <>
                <div className="px-3.5 py-2 bg-slate-50 rounded-lg flex items-center justify-between">
